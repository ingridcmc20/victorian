...
public interface OrdenTrabajoDetalleMapper {
	@Insert("INSERT INTO victorian.t_orden_trabajo_detalle(id_orden_trabajo, id_etapa, id_plan_produccion, fecha_fin, "
	...
	@Update("UPDATE victorian.t_orden_trabajo_detalle SET fecha_real_termino=#{fecha_real_termino} WHERE id_orden_trabajo=#{id_orden_trabajo} and id_etapa=#{id_etapa}")
