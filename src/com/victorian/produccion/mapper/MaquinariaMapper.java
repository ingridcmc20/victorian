...
public interface MaquinariaMapper {
	@Select("SELECT idmaquinaria, descripcion, modelo, serie, estado, tipo FROM victorian.t_maquinaria where tipo=#{tipo}")
	...
	@Select("SELECT m.idmaquinaria, m.descripcion, m.modelo, m.serie, m.estado, m.tipo "
			+ "FROM victorian.t_maquinaria m inner join victorian.t_orden_trabajo_maquinaria oto on oto.id_maquinaria=m.idmaquinaria "
	...
	@Select("SELECT idmaquinaria, descripcion, modelo, serie, estado, tipo FROM victorian.t_maquinaria where idmaquinaria=#{idmaquinaria}")
