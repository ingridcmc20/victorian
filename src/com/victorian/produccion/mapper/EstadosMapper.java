...
public interface EstadosMapper {
	...
	@Select("select id_estado, id_categoria_estado, id_producto as idProducto, descripcion, estado , id_estado_padre, descripcion_banco from t_estado where id_estado = #{id_estado}")
	...
	@Select("select id_estado from t_estado where id_producto = #{id_producto} and id_categoria_estado = 10 and descripcion = 'PENDIENTE' LIMIT 1 ")
