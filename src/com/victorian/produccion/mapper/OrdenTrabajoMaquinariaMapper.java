...
public interface OrdenTrabajoMaquinariaMapper {
	@Insert("INSERT INTO t_orden_trabajo_maquinaria(id_maquinaria, id_orden_trabajo, id_prioridad) "
			+ "VALUES (#{idmaquinaria}, #{id_orden_trabajo}, #{id_prioridad})")
	public void insert(OrdenTrabajoMaquinaria ordenTrabajoMaquinaria);
	
	@Delete("delete from t_orden_trabajo_maquinaria where id_orden_trabajo=#{id_orden_trabajo}")
