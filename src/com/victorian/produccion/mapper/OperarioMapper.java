...
public interface OperarioMapper {
	...
	@Select("SELECT o.idoperario, o.tipo_operario, o.estado, u.apellido_paterno || ' ' || u.apellido_materno || ' ' "
			+ "|| u.nombre as nombre_operario FROM victorian.t_operario o inner join victorian.t_usuario u on u.idusuario=o.idoperario "
	...
	@Select("SELECT o.idoperario, o.tipo_operario, o.estado, u.apellido_paterno || ' ' || u.apellido_materno || ' ' "
			+ "|| u.nombre as nombre_operario FROM victorian.t_operario o inner join victorian.t_usuario u on u.idusuario=o.idoperario "
			+ "where tipo_operario=#{tipo_operario} and o.idoperario not in (select x.id_operario from victorian.t_orden_trabajo_operario x inner join victorian.t_orden_trabajo y on y.id_orden_trabajo=x.id_orden_trabajo where y.id_estado not in (6))")
	...
	@Select("SELECT o.idoperario, o.tipo_operario, o.estado, u.apellido_paterno || ' ' || u.apellido_materno || ' ' "
			...
			+ "FROM victorian.t_operario o inner join victorian.t_usuario u on u.idusuario=o.idoperario "
	...
	@Select("SELECT o.idoperario||'' as idoperario "
			+ "FROM victorian.t_operario o inner join victorian.t_usuario u on u.idusuario=o.idoperario inner join victorian.t_orden_trabajo_operario oto on oto.id_operario=o.idoperario "
	...
	@Update("UPDATE victorian.t_operario SET puntaje_obtenido=#{puntaje_obtenido}, puntaje_acumulado=#{puntaje_acumulado}, id_nivel=#{id_nivel}, fecha_subida_nivel=#{fecha_subida_nivel} WHERE idoperario=#{idoperario}")
