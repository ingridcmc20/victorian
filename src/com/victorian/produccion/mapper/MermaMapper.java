...
public interface MermaMapper {
	@Select("SELECT id_merma, id_orden_trabajo, descripcion, id_estado FROM t_merma where id_estado=8 order by descripcion")
	...
	@Insert("INSERT INTO t_merma(id_orden_trabajo, descripcion, id_estado) "
