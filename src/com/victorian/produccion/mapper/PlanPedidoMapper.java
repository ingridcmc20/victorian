...
public interface PlanPedidoMapper {
	@Insert("INSERT INTO t_plan_pedido(idplan, idpedido, idfichatecnica, fechainicio, fechafin, estado) "
	...
	@Select("SELECT idplan, idpedido, idfichatecnica, fechainicio, fechafin, estado FROM t_plan_pedido "
			+ "where idpedido=#{idpedido}")
	public PlanPedido findByPedido(Integer idpedido) throws Exception;
	
	@Select("SELECT DISTINCT idplan, idpedido FROM t_plan_pedido where idpedido=#{idpedido}")
