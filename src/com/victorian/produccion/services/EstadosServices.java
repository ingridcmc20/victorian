...
import com.victorian.produccion.mapper.EstadosMapper;
...
public class EstadosServices implements EstadosMapper {
	...
	@Override
	public Integer getIdEstadoPENDByProduct(Integer id_producto)
			throws Exception {
		// TODO Auto-generated method stub
		return estadosMapper.getIdEstadoPENDByProduct(id_producto);
	}
