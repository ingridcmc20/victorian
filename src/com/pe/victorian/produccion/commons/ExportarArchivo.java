...
public class ExportarArchivo {
	 ...
	 * 
	 * @param [jasperFile]
	 *            [Nombre del archivo compilado .jaspe], tipo [String].
	 * @param [parameters]
	 *            [Ingreso de parametros que pueden ser utilizados en el
	 *            jasper], tipo [Map<>].
	 * @return [dataList] [Arreglo que contiene los registros que deberá pintar
	 *         el jasperreport], tipo [List<?>].
	 * @throws [nombre
	 *             de excepción] [explicación].
	 */
	public static byte[] exportPdf(String jasperFile, Map<String, Object> parameters, List<?> dataList)
			throws Exception {
	 ...
	 *             de excepción] [explicación].
	 */
	public static byte[] exportXlsX(String jasperFile, Map<String, Object> parameters, List<?> dataList,
			boolean isOnePagePerSheet) throws Exception {
		...
		// exporter.setParameter(JRXlsExporterParameter.CREATE_CUSTOM_PALETTE,
		// Boolean.TRUE);
	...
	public static byte[] exportXls(String jasperFile, Map<String, Object> parameters, List<?> dataList,
			boolean isOnePagePerSheet) throws Exception {
		parameters.put(JRParameter.IS_IGNORE_PAGINATION, Boolean.TRUE);
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperFile, parameters,
				new JRBeanCollectionDataSource(dataList));
		...
		// exporter.setParameter(JExcelApiExporterParameter.CREATE_CUSTOM_PALETTE,
		// Boolean.TRUE);
	...
	public static byte[] exportMultipleSheetXls(List<JasperPrint> jaspers) throws Exception {
		...
		// parameters, new JRBeanCollectionDataSource(dataList));
	...
	public static byte[] exportCSV(String jasperFile, Map<String, Object> parameters, List<?> dataList,
			boolean isOnePagePerSheet) throws Exception {
		parameters.put(JRParameter.IS_IGNORE_PAGINATION, Boolean.TRUE);
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperFile, parameters,
				new JRBeanCollectionDataSource(dataList));
	...
	public static void executeExccel(byte[] bytes, String name) throws Exception {
		try {
