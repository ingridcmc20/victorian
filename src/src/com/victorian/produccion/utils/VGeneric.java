...
public class VGeneric {
	...
	private List<VGenericChild> childs = new ArrayList<VGenericChild>();
	...
	public List<VGenericChild> getChilds() {
		return childs;
	}

	public void setChilds(List<VGenericChild> childs) {
		this.childs = childs;
	}

	public Double gettDou01() {
		dou01 = 0.0;
		for (VGenericChild ch : getChilds()) {
			dou01 += ch.getDou01();
		}
		return dou01;
	}
